...
class Dispatch extends Controller_Template
{
    ...
    function before()
    {
        ...
        if ($this->auto_render) {
            ...
            $this->template->description = $GLOBALS['SITE_NAME'] . ' - позволяет провести интерактивные презентации, воркшопы и встречи. Спикеру становится проще взаимодействовать со всей аудиторией в режиме реального времени, посредством проведения электронного голосования с мгновенным получением результатов.';
