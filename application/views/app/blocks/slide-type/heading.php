<div class="m-t-20">
    ...
    <div class="form-group">
        ...
        <div class="form-group__control-group">
            ...
            <a id="" role="button" class="form-group__control-group-addon">
                <label for="bgImage" class="fa fa-image" aria-hidden="true"></label>
