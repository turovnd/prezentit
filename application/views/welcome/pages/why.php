    ...
    <div class="container m-t-50 m-b-100">
        ...
        <div class="row m-t-50">
            ...
            <div class="col-xs-12 col-sm-6 section--md valign fl_l">
                <img class="img--sale" src="<?=$assets; ?>static/img/welcome/slideshow.jpg" alt="Slide Show" height="300">
            </div>
        </div>
        ...
        <div class="row m-t-50">
            ...
            <div class="col-xs-12 col-sm-6 section--md valign fl_r">
                <img class="img--sale" src="<?=$assets; ?>static/img/welcome/application.jpg" alt="Application" >
            </div>
        </div>
        ...
        <div class="row m-t-50">
            ...
            <div class="col-xs-12 col-sm-6 section--md valign fl_l">
                <img class="img--sale" src="<?=$assets; ?>static/img/welcome/crossplatform.jpg" alt="Cross Platform" height="200">
            </div>
        </div>
        ...
        <div class="row m-t-50">
            ...
            <div class="col-xs-12 col-sm-6 section--md valign fl_r">
                <img class="img--sale" src="<?=$assets; ?>static/img/welcome/ssl.jpg" alt="SSL" height="250">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="usecase__block">
                    ...
                    <p class="usecase__text">
                        Проведите корпоративные тренинги по-новому: задавайте вопрос и узнавайте мнения каждого присутствующего, тем самым вовлекая всех в процесс обучения.
                    </p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4">
