...
<div class="section m-t-100 m-b-100">
    <div class="container animated fade__in">
        <div class="form" style="width: 300px; margin: 50px auto 0 auto;">
            ...
            <!-- SignIn Form -->
            <form class="form__body m-b-10" id="signin" action="<?=URL::site(''); ?>" method="POST">
                <div class="col-xs-12">
            ...
            <form class="form__body m-b-10" id="forget" action="<?=URL::site(''); ?>" method="POST">
                <div class="col-xs-12">
            ...
            <!-- Reset Password Form -->
            <form class="form__body m-b-10" id="reset" action="<?=URL::site(''); ?>" method="POST">
                <div class="col-xs-12">
                    ...
                    <input type="hidden" name="csrf" value="<?=Security::token(); ?>">
                    <button type="button" id="" class="btn btn--default btn--round col-xs-5">Отмена</button>
                    <button type="submit" id="" class="btn btn--brand btn--round col-xs-6 fl_r m-r-0">Восстановить</button>
                </div>
            </form>
